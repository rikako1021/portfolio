...
import product4 from '../image/mottaigo.png'
...
export default function Product() {
  ...
  const [modalStyle4] = React.useState(getModalStyles4);
  ...
  const body4 = (
    <div style={modalStyle4} className={classes4.paper}>
      <h2 id="simple-modal-title4">"食品ロス削減×デリバリー"をテーマにしたデリバリーwebアプリ</h2>
      <br/>
      <p id="simple-modal-description4">
        余った食品を飲食店が出品し、ユーザはそれを購入。
        ロスになる食品のみを出品＋配送を時間ごとの定期便にすることで単価引き下げを目指したデリバリーサービスです。
        <br/>＊SoftbankBBWCハッカソン成果物
        <br />
        <hr/>
        リソース：Vue.js, Node.js, Cloud Firestore, Firebase Authentication, Firebase Hosting 
        <br />
        <hr/>
        <div className="GithubLink"><a href="https://github.com/rikako1021/fs-delivery-app">Program</a></div>
      </p>
    </div>
  ); 
...
// function Product() {
 return (
   <div className="product">
    ...
    <button type="button" onClick={handleOpen4}>
     <section className="card4">
       <img className="card-img" src={product4} alt="" width="300px" height="300px" />
       <div className="card-content">
         <h1>Delivery App</h1>
         <br/>
       </div>
     ...
     aria-labelledby="simple-modal-title4"
     aria-describedby="simple-modal-description4"
     >
       {body4}
    </Modal>
